...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            <!-- begin::Tambah Satuan -->
            <button class="btn btn-sm btn-light-primary m-3" id="btnAddUnit">
    ...
    <div class="card-body py-3">
        ...
        <div class="table-responsive" id="tableUnit"></div>
        <!--end::Table container-->
    </div>
    <!--end::Card Body-->
</div>
...
<script>
    function showTable() {
        $.ajax({
            ...
            success: function(response) {
                $('#tableUnit').html(response.tableUnit);
            },
    ...
    function showModal(unitId = null) {
        $.ajax({
            type: "post",
            url: "/satuan/modal",
            data: {
            ...
            success: function(response) {
                if (response.addModal) {
                    $('.unitModal').html(response.addModal);
                    $('#addUnitModal').modal("show");
                }
                if (response.editModal) {
                    $('.unitModal').html(response.editModal);
